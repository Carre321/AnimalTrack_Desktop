...
public class EventoCreateView extends View {
    ...
    private void initialize() {
        ...
        agreeButton.setIcon(new ImageIcon(EventoCreateView.class.getResource("/nuvola/32x32/1847_save_guardar_disk.png")));
        buttonPanel.add(agreeButton);

        reloadButton = new JButton("Recargar");
        reloadButton.setIcon(new ImageIcon(EventoCreateView.class.getResource("/nuvola/32x32/1839_all_all_refresh_reload_sync_tabs_refresh_reload_sync_tabs.png")));
    ...
    private void configureSecondaryButton(boolean editable) {
        ...
        if (editable && parseLong(idTF.getText()) != null) {
            ...
            reloadButton.setIcon(new ImageIcon(EventoCreateView.class.getResource("/nuvola/32x32/1250_delete_delete.png")));
